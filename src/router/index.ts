...
const routes: Array<RouteRecordRaw> = [
  ...
  { path: "/custom-fabrication", name: "Custom Fabrication", component: CustomFabrication },
  { path: "/equipment-repair", name: "Equipment Repair", component: EquipmentRepair },
  { path: "/residential-welding", name: "Residential Welding", component: ResidentialWelding },
